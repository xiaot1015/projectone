 ...
 * 成绩不能修改和删除  只能查看
 */
class TargetScoreDetailAction extends Action{
	 ...
	 */
	public function getTargetScoreDetailList(){
...
//		$desc = $this->_param("question_desc");
	 ...
	 *  add one score info 
	 */
	public function addTargetScoreDetail(){
		$data = array();
	 ...
	 * 更新靶场比赛 成绩详细
	 */
	public function updateTargetScoreDetail(){
		$score_id = $this->_param("scoreid");
//		$user_id = $this->_param("userid");
//		$question_type = $this->_param("question_type");
//		$question_sequence = $this->_param("question_sequence");
